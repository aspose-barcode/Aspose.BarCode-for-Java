 ...
 */
public class QuickRecognitionExamplesOA
{
    ...
    public void read_Mixed_MaxQuality_AllSupported() throws Exception {
        ...
        assertRecognized("mixed.png", 3, qs, DecodeType.ALL_SUPPORTED_TYPES);
    }
    ...
    public void read_SmallModules_XDimensionSmall() throws Exception {
        ...
        assertRecognized("small_modules.png", 1, qs, DecodeType.QR);
    }
    ...
    public void read_LargeModules_XDimensionLarge() throws Exception {
        ...
        assertRecognized("large.png", 1, qs, DecodeType.PHARMACODE);
    }
    ...
    public void read_CustomMinimalXDimension_UseMinimalMode() throws Exception {
        ...
        assertRecognized("min_xdim.png", 1, qs, DecodeType.DATA_MATRIX);
    }
     ...
     * @param count  minimum expected recognized barcodes
     * @param qs        quality settings preset or tuned settings (nullable)
     */
    private void assertRecognized(String imageName, int count, QualitySettings qs, BaseDecodeType decodeType) throws Exception {
        ...
        System.out.println("Image " + imageName + " recognized and contains  " + results.length + " barcode(s)");
