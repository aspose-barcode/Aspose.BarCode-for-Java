...
type: docs
weight: 60
url: /java/aspose-barcode-for-android-via-java-19-7/
---

{{% alert color="primary" %}} 

This page contains release notes information for [Aspose.BarCode for Android via Java 19.7](https://downloads.aspose.com/barcode/androidjava/new-releases/aspose.barcode-for-android-via-java-19.7/).
