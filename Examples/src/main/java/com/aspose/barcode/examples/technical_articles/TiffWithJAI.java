...
/**
 * Read barcodes from multi-page TIFF image sample Integreted Sun's JAI (Java
 * Advanced Imaging) Library to working with tiff files Details information
 * about JAI: http://java.sun.com/javase/technologies/desktop/media/
 */
