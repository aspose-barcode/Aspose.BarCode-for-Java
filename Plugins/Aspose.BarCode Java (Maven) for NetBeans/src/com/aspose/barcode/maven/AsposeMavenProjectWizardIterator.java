package com.aspose.barcode.maven;

import com.aspose.barcode.maven.artifacts.Metadata;
...
import static com.aspose.barcode.maven.utils.AsposeMavenProjectManager.getAsposeProjectMavenDependencies;
import com.aspose.barcode.maven.utils.AsposeBarCodeJavaAPI;
import com.aspose.barcode.maven.utils.TasksExecutor;
...
@TemplateRegistration(
        ...
        description = "AsposeBarCodeMavenDescription.html",
        iconBase = "com/aspose/barcode/maven/Aspose.png",
        position = 1,
        content = "AsposeMavenProject.zip")
@Messages("Aspose_displayName=Aspose.BarCode Maven Project")
